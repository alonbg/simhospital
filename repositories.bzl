...
def go_repositories():
    ...
    go_repository(
        ...
        sha256 = "97b27cb581fd96700ff1055dc1e4929d62f97b5c4dae6c897e4f7928bc7393a9",
        strip_prefix = "fhir-0.7.3",
        type = "zip",
        urls = ["https://github.com/google/fhir/archive/refs/tags/v0.7.3.zip"],
    )
    # go_repository(
    #     name = "com_github_google_fhir_go",
    #     importpath = "github.com/google/fhir/go",
    #     sum = "h1:TjBCvuF6JLLfP+lRXqJBd6QNFB9+lWjpIIwO/VlVgp4=",
    #     version = "v0.0.0-20210908190838-d77f57706c1a",
    # )

    #v0.0.0-20210908190838-d77f57706c1a h1:TjBCvuF6JLLfP+lRXqJBd6QNFB9+lWjpIIwO/VlVgp4=
    # go_repository(
    #     name = "com_google_fhir",
    #     importpath = "google/fhir",
    ...
    go_repository(
        ...
        sum = "h1:F721VBMijn0OBFZ5wUSuMVVLQj2IJiiupn6UNd7UbBE=",
        version = "v0.0.5-0.20200416053754-163badb3bac6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:ycK2Bo0PJOLYrWRbZDfh5NFa+gNKqa+77M8bN0edEI4=",
        version = "v0.7.0",
    )
    go_repository(
